...
export const startText = "Привет! Я бот Научного центра \"Переработки ресурсов\". Если ты хочешь узнать, как получить доступ в лабораторию - нажми на кнопку \"Инструкция\". Также ты можешь узнать больше о научных направлениях, которые существуют в нашем научном центре. А также вступить в группу Студенческого научного клуба \"Технолог\""

export const instruction = ""

export const scientistsText = "Выберите научное направление:"